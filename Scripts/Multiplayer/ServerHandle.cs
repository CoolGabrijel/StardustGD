...
namespace Stardust.Godot
{
	public static partial class ServerHandle
    {
        ...
        public static void ReceivePickup(Message _msg)
        {
            ...
            PickUpPart pickupAction = new(pawn.Type, pawn.Room.RoomType, itemType);
            pickupAction.Do();
        ...
        public static void ReceiveRepair(Message _msg)
        {
            ...
            Pawn pawn = GameLogic.TurnQueue.CurrentPawn;
            new RepairRoom(pawn.Room.RoomType, pawn.Type).Do();
        ...
        public static void ReceiveWolframHeal(Message _msg)
        {
            ...
            ServerSend.WolframHeal(id,  targetType);
        }
    } 
}
